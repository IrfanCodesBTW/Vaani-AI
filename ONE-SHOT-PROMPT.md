# Vaani AI Voice Platform, one-shot prompt
...
```
You are setting up the Vaani AI Voice Platform: a self-hosted AI phone agent that
...
| Console | Vaani AI Console | Zero-dependency Node app, agent builder plus voice studio |
