'use strict';
/* Vaani AI Voice Studio , front-end. Talks only to our own /api/* (keys stay server-side). */
...
function addBubble(role, text) {
  ...
  b.innerHTML = `<span class="who">${role === 'user' ? 'you' : 'vaani'}</span>${text}`;
...
/* ===== Vaani AI promo popup + owner off-switch ===== */
(function promos() {
